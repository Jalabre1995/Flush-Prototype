...
var InternalUpload = function InternalUpload(props, ref) {
  ...
  var forceUpdate = (0, _useForceUpdate["default"])(); // `fileListRef` used for internal state sync to avoid control mode set it back when sync update.
  // `visibleFileList` used for display in UploadList instead.
  // It's a workaround and not the best solution.

  var fileListRef = React.useRef(fileListProp || defaultFileList || []);
  var visibleFileList = fileListProp || fileListRef.current;
  ...
  var onStart = function onStart(file) {
    ...
    var nextFileList = fileListRef.current.concat();
  ...
  var onSuccess = function onSuccess(response, file, xhr) {
    ...
    var targetItem = (0, _utils.getFileItem)(file, fileListRef.current); // removed
  ...
  var handleRemove = function handleRemove(file) {
    Promise.resolve(typeof onRemove === 'function' ? onRemove(file) : onRemove).then(function (ret) {
      ...
      var removedFileList = (0, _utils.removeFileItem)(file, fileListRef.current);
  ...
  var beforeUpload = function beforeUpload(file, fileListArgs) {
    ...
    if (result === false) {
      ...
      var uniqueList = [];
      fileListRef.current.concat(fileListArgs.map(_utils.fileToObject)).forEach(function (f) {
  ...
  if (type === 'drag') {
    ...
    var dragCls = (0, _classnames["default"])(prefixCls, (_classNames = {}, (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-drag"), true), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-drag-uploading"), fileListRef.current.some(function (file) {
