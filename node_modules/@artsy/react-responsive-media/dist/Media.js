      ...
      value: function render() {
        ...
        return _react.default.createElement(MediaContext.Consumer, null, function () {
          ...
          var children = props.children,
              ...
              breakpointProps = _objectWithoutProperties(props, ["children", "interaction"]);
          ...
          if (props.interaction) {
            ...
            if (props.at) {
              ...
              if (props.at === largestBreakpoint) {
                ...
                console.warn("[@artsy/react-responsive-media] " + "`at` is being used with the largest breakpoint. " + "Consider using `<Media greaterThanOrEqual=" + "\"".concat(largestBreakpoint, "\">` to account for future ") + "breakpoint definitions outside of this range.".concat(ownerName ? " It is being used in the ".concat(ownerName, " component.") : ""));
              }
            }
          ...
          if (props.children instanceof Function) {
            ...
            return _react.default.createElement("div", {
              className: "rrm-container ".concat(className),
