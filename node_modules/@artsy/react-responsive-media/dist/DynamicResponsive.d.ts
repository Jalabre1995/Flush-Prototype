...
export declare function createResponsiveComponents<M extends string>(): {
    ...
    Provider: {
        new (props: ResponsiveProviderProps<M>): {
            ...
            render(): JSX.Element;
            context: any;
            setState<K extends "mediaQueryMatchers" | "mediaQueryMatches">(state: ResponsiveProviderState | ((prevState: Readonly<ResponsiveProviderState>, props: Readonly<ResponsiveProviderProps<M>>) => ResponsiveProviderState | Pick<ResponsiveProviderState, K> | null) | Pick<ResponsiveProviderState, K> | null, callback?: (() => void) | undefined): void;
