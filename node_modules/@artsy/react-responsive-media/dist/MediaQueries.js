...
function () {
  ...
  function MediaQueries(breakpoints, interactions) {
    ...
    _defineProperty(this, "toStyle", function () {
      return [// Don’t add any size to the layout
      ".rrm-container{margin:0;padding:0;}"].concat(_toConsumableArray(_this._breakpoints.toRuleSets()), _toConsumableArray(_this._interactions.toRuleSets())).join("\n");
    });
