...
function () {
  ...
  function Breakpoints(_breakpoints) {
    ...
    this._mediaQueries = {
      ...
      lessThan: this._createBreakpointQueries("lessThan", this._sortedBreakpoints.slice(1)),
      greaterThan: this._createBreakpointQueries("greaterThan", this._sortedBreakpoints.slice(0, -1)),
      greaterThanOrEqual: this._createBreakpointQueries("greaterThanOrEqual", this._sortedBreakpoints),
  ...
  _createClass(Breakpoints, [{
    ...
    value: function toRuleSets() {
      return Object.entries(this._mediaQueries).reduce(function (acc, _ref3) {
    ...
    value: function shouldRenderMediaQuery(breakpointProps, onlyRenderAt) {
      ...
      if (breakpointProps.lessThan) {
        ...
        var lowestAllowedWidth = Math.min.apply(Math, _toConsumableArray(onlyRenderAt.map(function (breakpoint) {
          return _this2._breakpoints[breakpoint];
        })));
    ...
    value: function _createBreakpointQueries(key, forBreakpoints) {
      ...
      return forBreakpoints.reduce(function (map, breakpoint) {
        map.set(breakpointKey(breakpoint), _this3._createBreakpointQuery(_defineProperty({}, key, breakpoint)));
        return map;
      }, new Map());
    }
  }, {
    ...
    get: function get() {
      return Array.from(this._mediaQueries.at.entries()).reduce(function (acc, _ref5) {
